...
# Configure Kuhnke FIO Drive terminal
epicsEnvSet("ECMC_EC_SLAVE_NUM",              "26")
< ../hardware/ecmcFIODrive-StepperDrive$(ECMC_GEN_EC_RECORDS)

# Configure Kuhnke FIO Drive terminal for Amp Motor
< ../hardware/ecmcFIODrive-Motor-Amp-57TH76-4280

# Apply hardware configuration
EthercatMCConfigController ${ECMC_MOTOR_PORT}, "Cfg.EcApplyConfig(1)"

#(Write Operation mode Only supports 1ms sampletime valid for mode 9). Velocity profile mode=2
#EthercatMCConfigController "MCU1", "Cfg.WriteEcEntryIDString(${ECMC_EC_SLAVE_NUM},OP_MODE_CMD,2)"
