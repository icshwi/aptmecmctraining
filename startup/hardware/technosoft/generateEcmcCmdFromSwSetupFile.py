  ...
  def parse(self):
    ...
    for line in inputFile.readlines():
      ...
      if len(line)==0:
        ...
        outputFile.write('EthercatMCConfigController ${ECMC_MOTOR_PORT}, "Cfg.EcWriteSdo(${ECMC_EC_SLAVE_NUM},0x2069,0x0,'+ tempString +',4)"\n')
        ...
        outputFile.write('EthercatMCReadController ${ECMC_MOTOR_PORT}, "EcReadSdo(${ECMC_EC_SLAVE_NUM},0x206A,0x0,2)"\n')
        outputFile.write('#########################################################\n')
        ...
        outputFile.write('EthercatMCReadController ${ECMC_MOTOR_PORT}, "Cfg.EcWriteSdo(${ECMC_EC_SLAVE_NUM},0x2080,0x0,1,2)"\n')
        outputFile.write('epicsThreadSleep(' + str(self.epicsSleepTime) +')\n') #Sadly needed for this drive for some reason?
        return  
      ...
      if lineNumber==1:  
        ...
        outputFile.write('#########################################################\n')
        outputFile.write('EthercatMCConfigController ${ECMC_MOTOR_PORT}, "Cfg.EcWriteSdo(${ECMC_EC_SLAVE_NUM},0x2064,0x0,' + startAdressString+ ',4)"\n')  
        outputFile.write('epicsThreadSleep(' + str(self.epicsSleepTime) +')\n') #Sadly needed for this drive for some reason?
        startAdressFound=1
        continue
      ...
      data='0x'+line
      outputFile.write('EthercatMCConfigController ${ECMC_MOTOR_PORT}, "Cfg.EcWriteSdo(${ECMC_EC_SLAVE_NUM},0x2065,0x0,' + data+ ',4)"\n')
      outputFile.write('epicsThreadSleep(' + str(self.epicsSleepTime) +')\n') #Sadly needed for this drive for some reason?
