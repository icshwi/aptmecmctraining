...
# Configure EL5002 input terminal
epicsEnvSet("ECMC_EC_SLAVE_NUM",              "19")
<../hardware/ecmcEL5002-ssiEncoder$(ECMC_GEN_EC_RECORDS)

# Configure Wachendorff encoder on channel 1
<../hardware/ecmcEL5002-Encoder-ch1-Wachendorff-WDGA36E-06-1218-SIA-B01-CB8
