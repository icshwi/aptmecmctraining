...
# Print All hardware for seleted hardware
EthercatMCConfigController ${ECMC_MOTOR_PORT}, "EcPrintAllHardware()"

EthercatMCConfigController "$(ECMC_MOTOR_PORT)", "Cfg.EcEnablePrintouts(0)"

#Auto configure slave 1
EthercatMCConfigController ${ECMC_MOTOR_PORT}, "Cfg.EcSlaveAutoConfig(1)"
