...
< $(ECMC_STARTUP_TOP)/hardware/ecmcIPOS8020-driveCSV${ECMC_GEN_EC_RECORDS}

# Configure Motor
< $(ECMC_STARTUP_TOP)/hardware/ecmcIPOS8020-Motor-OrientalMotor-PK296DB

# Download base config (parsed from Techosoft EasySetup configuration): Only needed first time a drive is used..
< $(ECMC_STARTUP_TOP)/hardware/ecmcIPOS8020-EEPROM-BaseConfig-StepperOpenLoopCSV
